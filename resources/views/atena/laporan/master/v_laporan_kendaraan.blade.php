...
@section('content')
  <div class="easyui-layout" style="width:350px;height:100%; font-weight:bold;" fit="true">
    <div class="panel-filter-laporan" data-options="region:'west',hideCollapsedContent:false" title="{{ $menu }}">
      <table style="border-bottom:1px #000" id="label_laporan">
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_kendaraan">
              <input id="txt_nilai_list_kendaraan" name="txt_nilai_list_kendaraan" style="width:229px" prompt="Nilai" />
            </div>
          </td>
        </tr>
        <tr valign="top">
      ...
      <input type="hidden" name="file_name" id="file_name" value="LaporanKendaraan">
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Kendaraan";
    var namaKolom = "Kendaraan";
    var kolomVal = "mkendaraan.kodekendaraan"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Kendaraan' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanKendaraan, {
        filename: "Laporan Master Kendaraan",
