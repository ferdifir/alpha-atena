        ...
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:220px;">
              <option value="kartuuangmukapo.kodepo">Kode PO</option>
...
@push('js')
  <script>
    ...
    var kolom = "Kode PO";
    var namaKolom = "PO";
    var kolomVal = "kartuuangmukapo.kodepo";
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $("#btn_add").click(function() {
      ...
      } else if (namaKolom == 'PO' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanUangMukaPembelian, {
        kode: "{{ $kodemenu }}",
        ...
        excel: excel,
        filename: "Laporan Uang Muka Pembelian",
      });
    }
