                    ...
                    <fieldset style="height:120px;">
                      ...
                      <table border="0">
                        <tr>
                          ...
                          <td id="label_form"><input name="kodeterimatransfer" id="KODETERIMATRANSFER" class="label_input"
                              style="width:190px">
                            <input type="hidden" id="IDTERIMATRANSFER" name="uuidterimatransfer">
                            <input type="hidden" id="TGLENTRY" name="tglentry">
                          </td>
                        </tr>
                        <tr>
                          <td id="label_form">Lokasi Tujuan</td>
                          <td id="label_form"><input name="uuidlokasitujuan" id="IDLOKASITUJUAN" style="width:190px"></td>
                    ...
                    <fieldset style="height:120px;" id="field_referensi">
                      ...
                      <table border="0">
                        <tr @if ($transaksi != 'HEADER') hidden @endif>
                          ...
                          <td id="label_form" align="right"><input name="uuidtransfer" id="IDTRANSFER"
                        ...
                        <tr>
                          ...
                          <td align="right">
                            <input name="uuidlokasiasal" class="label_input" id="IDLOKASIASAL" style="width:190px"
                              readonly>
