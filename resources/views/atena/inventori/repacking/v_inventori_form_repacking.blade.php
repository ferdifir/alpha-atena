          ...
          <div class="easyui-layout" style="height:100%" id="trans_layout">
                    ...
                    <fieldset style="height:230px;">
                      ...
                      <table border="0">
                        <tr>
                          ...
                          <td id="label_form"><input name="koderepacking" id="KODEREPACKING" class="label_input"
                              style="width:190px">
                        ...
                        <tr>
                          ...
                          <td id="label_form"><input name="uuidso" id="IDSO" style="width:190px"></td>
                        </tr>
                        <tr>
                          <td id="label_form">Barang</td>
                          <td id="label_form"><input name="uuidbarang" id="IDBARANG" style="width:190px"></td>
                          <input type="hidden" id="KODEBARANG" name="kodebarang">
                        </tr>
                        <tr>
                          <td id="label_form">
                            <input type="radio" id="JENISJMLSET" name="jenis" value="JMLSET">
                            Jumlah Set
                          </td>
                          <td id="label_form">
                            <input name="jmlset" id="JMLSET" value="1" style="width:60px">
                          </td>
                        </tr>
                        <tr>
                          <td id="label_form">Jumlah Barang 1 Set</td>
                          <td id="label_form">
                            <input name="jmlhasilset" id="JMLHASILSET" class="number" readonly value="1"
                              style="width:60px">
                            <input name="satuanutama" id="SATUANUTAMA" style="width:60px" class="label_input" readonly>
                          </td>
                        </tr>
                        <tr>
                          <td id="label_form">
                            <input type="radio" id="JENISJMLHASIL" name="jenis" value="JMLHASIL">
                            Total Jumlah Barang Dihasilkan
                          </td>
                          <td id="label_form">
                            <input name="jml" id="JML" value="1" class="number" style="width:60px">
            ...
            <div data-options="region:'south',border:false" style="width:100%; height:35px;">
              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left" id="label_form"><label style="font-weight:normal" id="label_form">User :</label>
