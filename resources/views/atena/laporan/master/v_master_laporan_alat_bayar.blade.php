      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        ...
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:229px;">
              <option value="malatbayar.kodealatbayar">Kode Alat Bayar</option>
              <option value="malatbayar.namaalatbayar">Nama Alat Bayar</option>
            </select>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_alat_bayar">
              <input id="txt_nilai_list_alat_bayar" name="txt_nilai_list_alat_bayar" style="width:229px" prompt="Nilai" />
            </div>
          </td>
        </tr>
        <tr valign="top">
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Alat Bayar";
    var namaKolom = "Alat Bayar";
    var kolomVal = "malatbayar.kodealatbayar"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $(document).ready(function() {
      ...
      browse_data_alat_bayar('#txt_nilai_list_alat_bayar');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        if (checkData == "Kode" || checkData == "Nama") {
          ...
          if (namaKolom == 'Alat Bayar') {
            $('#hide_nilai_list_alat_bayar').show();
          }
          ...
          $('#hide_nilai_list_alat_bayar').hide();
        ...
        $('#txt_nilai_list_alat_bayar').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Alat Bayar' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_alat_bayar').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanAlatBayar, {
        filename: "Laporan Master Alat Bayar",
    ...
    function browse_data_alat_bayar(id) {
      $(id).combogrid({
        panelWidth: 220,
        url: link_api.browseAlatBayar,
        idField: 'nama',
        textField: 'nama',
        mode: 'remote',
        sortName: 'nama',
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_alat_bayar').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_alat_bayar').combogrid('setValue', data.nama);
          }
        }
      });
    }
