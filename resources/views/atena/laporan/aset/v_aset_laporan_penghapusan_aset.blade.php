...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Penghapusan Aset";
    var namaKolom = "Penghapusan Aset";
    var kolomVal = "tasethapus.kodeasethapus"
    var checkData = "Kode";
    var operator = "Adalah";
      ...
      onChange: function() {
        ...
        if (checkData == "Kode" || checkData == "Nama") {
          ...
          if (namaKolom == 'Aset') {
            ...
            $('#hide_nilai_list_aset_hapus').hide();
          } else if (namaKolom == 'Penghapusan Aset') {
            $('#hide_nilai_list_aset_hapus').show();
        ...
        $('#txt_nilai_list_aset_hapus').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      } else if (namaKolom == 'Penghapusan Aset' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_aset_hapus').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function browse_data_aset_hapus(id) {
      $(id).combogrid({
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_aset_hapus').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_aset_hapus').combogrid('setValue', data.nama);
          }
        }
