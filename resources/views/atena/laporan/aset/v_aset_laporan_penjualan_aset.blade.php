        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_aset_jual">
              <input id="txt_nilai_list_aset_jual" name="txt_nilai_list_aset_jual" style="width:220px" prompt="Nilai" />
            </div>
...
@push('js')
  <script>
    ...
    function browse_data_aset_jual(id) {
      $(id).combogrid({
        panelWidth: 230,
        url: base_url + 'atena/Aset/Transaksi/PenjualanAset/comboGridAsetJual',
        idField: 'kode',
        textField: 'kode',
        mode: 'remote',
        sortName: 'kode',
