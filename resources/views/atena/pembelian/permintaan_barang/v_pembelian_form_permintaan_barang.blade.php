                    ...
                    <fieldset id='fieldsetInfoTransaksi'>
                      ...
                      <table border="0">
                        <tr>
                          ...
                          <td id="label_form">
                            <input name="kodepr" id="kodepr" class="label_input" style="width:190px">
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td id="label_form">
                            <input name="uuidlokasikirim" id="idlokasikirim" style="width:190px">
                          </td>
                        </tr>
                        <tr hidden id='tr_approvejoborder'>
                          <td id="label_form">No. Approve Job Order</td>
                          <td id="label_form">
                            <input name="uuidapprovejoborder" id="idapprovejoborder" style="width:190px">
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td id="label_form">
                            <input name="tgltarget" id="tgltarget" class="date" style="width:190px" required>
                          </td>
                        </tr>
                      </table>
                    </fieldset>
