  ...
  <div class="easyui-layout" style="width:350px;height:100%; font-weight:bold;" fit="true">
    <div class="panel-filter-laporan" data-options="region:'west',hideCollapsedContent:false" title="{{ $menu }}">
      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        ...
        <tr>
          <td id="label_laporan">Kota </td>
          <td><input id="txt_kota" name="txt_kota[]" style="width:220px" /></td>
        </tr>
        <tr>
          <td id="label_laporan">
            Kolom
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:220px;">
              <option value="tbbk.kodebbk">Kode Bukti Pengeluaran Persediaan</option>
              <option value="mcustomer.kodecustomer">Kode Customer</option>
              <option value="mcustomer.namacustomer">Nama Customer</option>
              <option value="mkendaraan.kodekendaraan">Kode Kendaraan</option>
              <option value="mkendaraan.namakendaraan">Nama Kendaraan</option>
              <option value="msopir.kodesopir">Kode Sopir</option>
              <option value="msopir.namasopir">Nama Sopir</option>
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_kendaraan" hidden>
              <input id="txt_nilai_list_kendaraan" name="txt_nilai_list_kendaraan" style="width:220px" prompt="Nilai" />
            </div>
            <div id="hide_nilai_list_sopir" hidden>
              <input id="txt_nilai_list_sopir" name="txt_nilai_list_sopir" style="width:220px" prompt="Nilai" />
            </div>
            ...
            <div id="hide_nilai_list_bbk">
              <input id="txt_nilai_list_bbk" name="txt_nilai_list_bbk" style="width:220px" prompt="Nilai" />
            </div>
          </td>
        </tr>
        <tr valign="top">
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Bukti Pengeluaran Persediaan";
    var namaKolom = "Bukti Pengeluaran Persediaan";
    var kolomVal = "tbbk.kodebbk"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $(document).ready(function() {
      ...
      browse_data_kendaraan('#txt_nilai_list_kendaraan');
      browse_data_sopir('#txt_nilai_list_sopir');
      browse_data_barang('#txt_nilai_list_barang');
      browse_data_kota('#txt_kota');
      browse_data_bbk('#txt_nilai_list_bbk');
      ...
      $('#cbJenis').combogrid("grid").datagrid("appendRow", {
        value: 'PENJUALANSO',
        jenis: 'Pesanan Penjualan'
      });
      $('#cbJenis').combogrid("grid").datagrid("appendRow", {
        value: 'PENJUALANDO',
        jenis: 'Pesanan Pengiriman'
      });
      $('#cbJenis').combogrid("grid").datagrid("appendRow", {
        value: 'TRANSFER',
        jenis: 'Transfer'
      ...
      $('#cbJenis').combogrid("setValues", ["PENJUALANSO", "PENJUALANDO", "TRANSFER", "RETUR"]);
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        $('#txt_nilai_list_sopir').combogrid('clear');
        $('#txt_nilai_list_customer').combogrid('clear');
        $('#txt_nilai_list_kendaraan').combogrid('clear');
        $('#txt_nilai_list_barang').combogrid('clear');
        $('#txt_nilai_list_bbk').combogrid('clear');
      }
    });
    ...
    $("#btn_add").click(function() {
      ...
      } else if (namaKolom == 'Kendaraan' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_kendaraan').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
      } else if (namaKolom == 'Sopir' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_sopir').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
      ...
      } else if (namaKolom == 'Bukti Pengeluaran Persediaan' && (operator == "Adalah" || operator ==
          "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_bbk').combogrid('getValue')
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanBuktiPengeluaranBarang, {
        ...
        excel: excel,
        filename: "Laporan Bukti Pengeluaran Barang",
        kode: "{{ $kodemenu }}",
        jenis: JSON.stringify($('#cbJenis').combogrid("getValues")),
        kota: JSON.stringify($('#txt_kota').combogrid("getValues"))
      });
    }
    ...
    function browse_data_kendaraan(id) {
      $(id).combogrid({
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_kendaraan').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_kendaraan').combogrid('setValue', data.nama);
          }
        }
      });
    }

    function browse_data_sopir(id) {
      $(id).combogrid({
        panelWidth: 370,
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_sopir').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_sopir').combogrid('setValue', data.nama);
          }
        }
      });
    }
    ...
    function browse_data_bbk(id) {
      $(id).combogrid({
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_bbk').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_bbk').combogrid('setValue', data.nama);
          }
        }
