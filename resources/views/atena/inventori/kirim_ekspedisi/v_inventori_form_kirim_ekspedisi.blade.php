                                        ...
                                        <fieldset style="height:150px;">
                                            ...
                                            <table border="0">
                                                <tr>
                                                    ...
                                                    <td id="label_form">
                                                        <input name="kodekirim" id="KODEKIRIM" class="label_input"
                                                            style="width:190px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="label_form">
                                                        <input type="radio" name="rd_mode" id="rd_mode1" value="1"
                                                            checked>Auto
                                                        <input type="radio" name="rd_mode" id="rd_mode2"
                                                            value="2">Manual
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <fieldset style="height:150px;">
                                            ...
                                            <table border="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="uuidcustomer" class="label_input" id="IDCUSTOMER"
                                                            style="width:190px" prompt="Kode Customer">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="namacustomer" class="label_input" id="NAMACUSTOMER"
                                                            style="width:190px" readonly prompt="Nama Customer">
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="telp" class="label_input" id="TELP"
                                                            style="width:190px" readonly prompt="Telp Customer">
                                                    </td>
                                                </tr>
                                                <tr id="tr_surat_jalan" hidden>
                                                    <td id="label_form">No. Surat Jalan</td>
                                                    <td id="label_form"><input name="uuidbbk" id="IDBBK"
                                                            style="width:190px"></td>
                                        ...
                                        <fieldset style="height:150px;">
                                            ...
                                            <table border="0">
                                                <tr>
                                                    ...
                                                    <td id="label_form"><input name="uuidekspedisi" id="IDEKSPEDISI"
                                                            style="width:190px"></td>
                                                </tr>
                                                <tr>
                                                    <td id="label_form">Nama</td>
                                                    <td>
                                                        <input name="namaekspedisi" class="label_input"
                                                            id="NAMAEKSPEDISI" style="width:190px" readonly
                                                            prompt="Nama Ekspedisi">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td id="label_form">Alamat</td>
                                                    <td>
                                                        <input name="alamatekspedisi" class="label_input"
                                                            id="ALAMATEKSPEDISI" style="width:190px" readonly
                                                            prompt="Alamat Ekspedisi">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td id="label_form">Telp</td>
                                                    <td>
                                                        <input name="telpekspedisi" class="label_input"
                                                            id="TELPEKSPEDISI" style="width:190px" readonly
                                                            prompt="Telp Ekspedisi">
                                                    </td>
                                                </tr>
                                            </table>
                                        </fieldset>
        ...
        async function ubah() {
            ...
            if (row) {
                ...
                get_akses_user('{{ $kodemenu }}', 'bearer {{ session('TOKEN') }}', function(data) {
                    data = data.data;
                    var UT = data.ubah;
                    get_status_trans("atena/inventori/kirim-ekspedisi", 'uuidkirim', row.uuidkirim, function(
                        data) {
                        data = data.data;
                            ...
                            editor: {
                                ...
                                options: {
                                    ...
                                    onBeforeLoad: function(param) {
                                        ...
                                        param.customer = $("#IDCUSTOMER").combogrid('getValue');
                                    },
                                    columns: [
                                        [{
                                                field: 'uuidbbk',
        ...
        function hitung_subtotal_detail(index, row) {
            ...
            if ($("input[name='rd_mode']:checked").val() == 1) {
                ...
                for (var i = 0; i < rows.length; i++) {
                    if (index != i && (rows[i].uuidbbk != "" && row.uuidbbk == rows[i].uuidbbk) && (rows[i].uuidbarang !=
                            "" && row
