      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        ...
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:220px;">
              <option value="trepacking.koderepacking">Kode Repacking</option>
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_repacking">
              <input id="txt_nilai_list_repacking" name="txt_nilai_list_repacking" style="width:220px" prompt="Nilai" />
            </div>
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Repacking";
    var namaKolom = "Repacking";
    var kolomVal = "trepacking.koderepacking";
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $(document).ready(function() {
      ...
      browse_data_repacking('#txt_nilai_list_repacking');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        if (checkData == "Kode" || checkData == "Nama") {
          ...
          if (namaKolom == 'Repacking') {
            $('#hide_nilai_list_repacking').show();
            $('#hide_nilai_list_barang').hide();
          } else if (namaKolom == 'Barang') {
            $('#hide_nilai_list_barang').show();
            $('#hide_nilai_list_repacking').hide();
          }
        ...
        $('#txt_nilai_list_repacking').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Repacking' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_repacking').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function cetakLaporan(excel) {
      ...
      if (lokasi != null) {
        parent.buka_laporan(link_api.laporanRepacking, {
          kode: "{{ $kodemenu }}",
