        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_supplier">
              <input id="txt_nilai_list_supplier" name="txt_nilai_list_supplier" style="width:229px" prompt="Nilai" />
            </div>
          </td>
        </tr>
        <tr valign="top">
...
@push('js')
  <script>
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanSupplier, {
        filename: "Laporan Master Supplier",
