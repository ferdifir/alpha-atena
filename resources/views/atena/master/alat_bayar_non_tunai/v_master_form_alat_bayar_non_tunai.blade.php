                ...
                <td valign="top">
                  <table style="padding:5px" id="label_form">
                    <tr>
                      ...
                      <td><input id="KODENONTUNAI" name="kodenontunai" style="width:290px" class="label_input">
                    ...
                    <tr>
                      ...
                      <td><input name="namanontunai" style="width:350px" class="label_input" required="true"
                          validType='length[0,100]'></td>
                    </tr>
                    <tr>
                      <td align="right" id="label_form">Charge Customer</td>
                      <td>
                        <input name="charge" id="charge" style="width: 350px" class="number" required="true"
                          data-options="suffix: '%', min: 0">
                      </td>
                    </tr>
                    <tr>
                      <td align="right" id="label_form">Charge Bank</td>
                      <td>
                        <input name="chargebank" id="chargebank" style="width: 350px" class="number" required="true"
                          data-options="suffix: '%',min: 0">
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="uuidperkiraancharge" id="uuidperkiraancharge" style="width:350px">
                      </td>
                    </tr>
                    <tr>
