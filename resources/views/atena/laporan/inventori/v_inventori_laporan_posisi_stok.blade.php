    ...
    <div class="panel-filter-laporan" data-options="region:'west',hideCollapsedContent:false" title="{{ $menu }}">
      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        ...
        <tr>
          ...
          <td id="label_laporan"><input id="txt_tgl_ak" name="txt_tgl_ak" style="width:220px" class="date" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:220px;">
              ...
              <option value="sum(c.cekjml)">Stok</option>
            </select>
          </td>
        </tr>
        <tr>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      var arrayTampilLaporan = [{
          value: 'POSISISTOK',
          jenis: 'Posisi Stok Rekap 1'
        },
        {
          value: 'POSISISTOKBINTANG',
          jenis: 'Posisi Stok Rekap 2'
        },
        {
          value: 'POSISISTOKLOKASI',
          jenis: 'Posisi Stok Per Lokasi'
        }
      ];
    ...
    function cetakLaporan(excel) {
      ...
      if (lokasi != null) {
        parent.buka_laporan(link_api.laporanPosisiStok, {
          ...
          excel: excel,
          filename: "Laporan Posisi Stok",
          kode: "{{ $kodemenu }}",
          uuidlokasihargajual: $('#txt_lokasi_hargajual').combogrid('getValue')
        });
      } else {
