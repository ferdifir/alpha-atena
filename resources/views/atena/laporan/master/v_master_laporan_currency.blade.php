      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        ...
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:229px;">
              <option value="mcurrency.kodecurrency">Kode Currency</option>
              <option value="mcurrency.namacurrency">Nama Currency</option>
            </select>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_currency">
              <input id="txt_nilai_list_currency" name="txt_nilai_list_currency" style="width:229px" prompt="Nilai" />
            </div>
            <div id="hide_nilai_list_perusahaan" hidden>
              <input id="txt_nilai_list_perusahaan" name="txt_nilai_list_perusahaan" style="width:229px" prompt="Nilai" />
            </div>
          </td>
        </tr>
        <tr valign="top">
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Currency";
    var namaKolom = "Currency";
    var kolomVal = "mcurrency.kodecurrency"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $(document).ready(function() {
      ...
      browse_data_currency('#txt_nilai_list_currency');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        if (checkData == "Kode" || checkData == "Nama") {
          ...
          if (namaKolom == 'Currency') {
            $('#hide_nilai_list_currency').show();
            $('#hide_nilai_list_perusahaan').hide();
          } else if (namaKolom == 'Perusahaan') {
            $('#hide_nilai_list_perusahaan').show();
            $('#hide_nilai_list_currency').hide();
          }
        ...
        $('#txt_nilai_list_currency').combogrid('clear');
        $('#txt_nilai_list_perusahaan').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Currency' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_currency').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
      } else if (namaKolom == 'Perusahaan' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_perusahaan').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanCurrency, {
        filename: "Laporan Master Currency",
    ...
    function browse_data_currency(id) {
      $(id).combogrid({
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_currency').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_currency').combogrid('setValue', data.nama);
          }
        }
      });
    }
