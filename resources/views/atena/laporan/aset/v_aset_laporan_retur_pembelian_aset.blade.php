...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Retur Pembelian Aset";
    var namaKolom = "Retur Pembelian Aset";
    var kolomVal = "tasetreturbeli.kodeasetreturbeli"
    var checkData = "Kode";
    var operator = "Adalah";
      ...
      onChange: function() {
        ...
        if (checkData == "Kode" || checkData == "Nama") {
          ...
          if (namaKolom == 'Aset') {
            ...
            $('#hide_nilai_list_aset_retur_beli').hide();
          } else if (namaKolom == 'Supplier') {
            $('#hide_nilai_list_supplier').show();
            $('#hide_nilai_list_aset').hide();
            $('#hide_nilai_list_aset_retur_beli').hide();
          } else if (namaKolom == 'Retur Pembelian Aset') {
            $('#hide_nilai_list_aset_retur_beli').show();
            $('#hide_nilai_list_aset').hide();
            $('#hide_nilai_list_supplier').hide();
        ...
        $('#txt_nilai_list_aset_retur_beli').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      } else if (namaKolom == 'Retur Pembelian Aset' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_aset_retur_beli').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function browse_data_aset_retur_beli(id) {
      $(id).combogrid({
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_aset_retur_beli').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_aset_retur_beli').combogrid('setValue', data.nama);
          }
        }
