        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_syarat_bayar">
              <input id="txt_nilai_list_syarat_bayar" name="txt_nilai_list_syarat_bayar" style="width:229px"
                prompt="Nilai" />
            </div>
          </td>
        </tr>
...
@push('js')
  <script>
    ...
    $(document).ready(function() {
      ...
      browse_data_syarat_bayar('#txt_nilai_list_syarat_bayar');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        $('#txt_nilai_list_syarat_bayar').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Syarat Bayar' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_syarat_bayar').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function cetakLaporanSyaratBayar(excel) {
      parent.buka_laporan(link_api.laporanSyaratBayar, {
        filename: "Laporan Syarat Bayar",
    ...
    $("#btn_export_excel").click(function() {
      cetakLaporanSyaratBayar('ya');
    });

    $("#btn_print").click(function() {
      cetakLaporanSyaratBayar('tidak');
    });

    function browse_data_syarat_bayar(id) {
      $(id).combogrid({
        panelWidth: 229,
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_syarat_bayar').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_syarat_bayar').combogrid('setValue', data.nama);
          }
        }
      });
    }
