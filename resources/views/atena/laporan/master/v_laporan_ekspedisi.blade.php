      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        ...
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:229px;">
              <option value="mekspedisi.kodeekspedisi">Kode Ekspedisi</option>
              <option value="mekspedisi.namaekspedisi">Nama Ekspedisi</option>
            </select>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_ekspedisi">
              <input id="txt_nilai_list_ekspedisi" name="txt_nilai_list_ekspedisi" style="width:229px" prompt="Nilai" />
            </div>
          </td>
        </tr>
        <tr valign="top">
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Ekspedisi";
    var namaKolom = "Ekspedisi";
    var kolomVal = "mekspedisi.kodeekspedisi"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $(document).ready(function() {
      browse_data_ekspedisi('#txt_nilai_list_ekspedisi');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        if (checkData == "Kode" || checkData == "Nama") {
          ...
          if (namaKolom == 'Ekspedisi') {
            $('#hide_nilai_list_ekspedisi').show();
          }
          ...
          $('#hide_nilai_list_ekspedisi').hide();
        ...
        $('#txt_nilai_list_ekspedisi').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Ekspedisi' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_ekspedisi').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanEkspedisi, {
        filename: "Laporan Master Ekspedisi",
    ...
    function browse_data_ekspedisi(id) {
      $(id).combogrid({
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_ekspedisi').combogrid('setValue', data.kodeekspedisi);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_ekspedisi').combogrid('setValue', data.namaekspedisi);
          }
        }
      });
    }
