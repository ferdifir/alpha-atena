                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                @php
                                                    $gambaruser =
                                                        session('DATAUSER')['gambar'] ??
                                                        'assets/foto_user/NO_IMAGE.jpg';
                                                @endphp
                                                <img src="{{ $gambaruser }}"
                                            ...
                                            <td>
                                                <div id="profile_menu" style="width:200px; border-radius:5px;">
                                                    ...
                                                    @if (url()->current() != route('homepage.perusahaan') && count(session('LISTPERUSAHAAN')) > 1)
                                                        <div onclick="javascript:halamanPilihPerusahaan()"
                                                            data-options="iconCls:'icon-logout'">
                                                            Kembali ke Pilih Perusahaan
                                                        </div>
                                                    @endif
                                                    <div onclick="javascript:logout()"
                                                        data-options="iconCls:'icon-logout'">Keluar dari Aplikasi
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
