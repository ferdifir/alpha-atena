            ...
            <div data-options="region:'center',border:false">
              <table style="padding:5px" id="label_form">
                <tr>
                  ...
                  <td>
                    <input id="kodeperkiraan" name="kodeperkiraan" style="width:340px" class="label_input" required="true"
                ...
                <tr>
                  ...
                  <td>
                    <select name="kelompok" id="kelompok" style="width:400px" class="easyui-combobox" panelHeight="auto"
                      required="true">
                ...
                <tr>
                  ...
                  <td>
                    <select id="tipe" name="tipe" style="width:400px" class="easyui-combobox" panelHeight="auto">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <input name="namainduk" id="namainduk" style="width:315px" class="label_input" readonly>
                  </td>
                </tr>
                <tr>
                  <td align="right" id="label_form">Saldo</td>
                  <td>
                    <select id="saldo" name="saldo" style="width:400px" class="easyui-combobox" panelHeight="auto">
                      <option value=""> - </option>
                ...
                <tr>
                  ...
                  <td id="label_form">
                    <select name="kasbank" style="width:80px" class="easyui-combobox" panelHeight="auto" required="true"
                      data-options="
                                            editable: false,
                    ...
                    &nbsp;
                    Kode Kas-Bank
                    <input id="kodekasbank" name="kodekasbank" style="width:210px" class="label_input"
                ...
                <tr>
                  <td></td>
                  <td>
                    <label> <input id="akunpiutang" name="akunpiutang" type="checkbox" value="1"> Akun
                      Piutang</label>
                    &nbsp; &nbsp; &nbsp; &nbsp;
