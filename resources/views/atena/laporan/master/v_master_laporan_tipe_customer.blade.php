        ...
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:229px;">
              <option value="mtipecustomer.kodetipecustomer">Kode Tipe Customer</option>
              <option value="mtipecustomer.namatipecustomer">Nama Tipe Customer</option>
            </select>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_tipecustomer">
              <input id="txt_nilai_list_tipecustomer" name="txt_nilai_list_tipecustomer" style="width:229px"
                prompt="Nilai" />
            </div>
          </td>
        </tr>
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Tipe Customer";
    var namaKolom = "TipeCustomer";
    var kolomVal = "mtipecustomer.kodetipecustomer"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        if (checkData == "Kode" || checkData == "Nama") {
          ...
          if (namaKolom == 'TipeCustomer') {
            $('#hide_nilai_list_tipecustomer').show();
          }
          ...
          $('#hide_nilai_list_tipecustomer').hide();
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'TipeCustomer' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_tipecustomer').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanTipeCustomer, {
        filename: "Laporan Master Tipe Customer",
    ...
    function browse_data_tipecustomer(id) {
      $(id).combogrid({
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_tipecustomer').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_tipecustomer').combogrid('setValue', data.nama);
          }
        }
      });
    }
