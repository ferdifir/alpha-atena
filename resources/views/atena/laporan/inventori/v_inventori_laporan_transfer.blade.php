        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_transfer">
              <input id="txt_nilai_list_transfer" name="txt_nilai_list_transfer" style="width:220px" prompt="Nilai" />
            </div>
...
@push('js')
  <script>
    ...
    $(document).ready(function() {
      browse_data_lokasiasal('#txt_lokasi');
      browse_data_lokasitujuan('#txt_lokasi_tujuan');
      browse_data_barang('#txt_nilai_list_barang');
      browse_data_transfer('#txt_nilai_list_transfer');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        $('#txt_nilai_list_transfer').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Barang' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        ...
        nilai = $('#txt_nilai_list_transfer').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function browse_data_transfer(id) {
      $(id).combogrid({
        panelWidth: 230,
        url: link_api.browseTransferPersediaan,
        idField: 'kode',
        textField: 'kode',
        mode: 'remote',
        sortName: 'kode',
    ...
    function cetakLaporan(excel) {
      ...
      if (lokasi != null) {
        ...
        parent.buka_laporan(link_api.laporanTransferPersediaan, {
          kode: "{{ $kodemenu }}",
