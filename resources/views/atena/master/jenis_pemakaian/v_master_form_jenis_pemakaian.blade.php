            ...
            <div data-options="region:'north',border:false" style="width:100%; height:350px;">
              <table style="padding:5px" id="label_form">
                <tr>
                  ...
                  <td>
                    <input id="kodejenispemakaian" name="kodejenispemakaian" style="width:290px" class="label_input">
                ...
                <tr>
                  ...
                  <td><input name="namajenispemakaian" style="width:350px" class="label_input" required="true"
                      validType='length[0,100]'></td>
                </tr>
                <tr>
                  <td align="right" id="label_form">Perkiraan Biaya/HPP</td>
                  <td>
                    <input name="uuidperkiraan" id="uuidperkiraan" style="width:350px" class="label_input" required="true"
