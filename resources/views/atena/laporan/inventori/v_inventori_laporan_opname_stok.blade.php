        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_opname_stok_persediaan">
              <input id="txt_nilai_list_opname_stok_persediaan" name="txt_nilai_list_opname_stok_persediaan"
...
@push('js')
  <script>
    ...
    $(document).ready(function() {
      ...
      browse_data_opname_stok_persediaan('#txt_nilai_list_opname_stok_persediaan');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        $('#txt_nilai_list_opname_stok_persediaan').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Opname Stok Persediaan' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_opname_stok_persediaan').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanOpnameStok, {
        kode: "{{ $kodemenu }}",
    ...
    function browse_data_opname_stok_persediaan(id) {
      $(id).combogrid({
        panelWidth: 230,
        url: link_api.browseOpnameStokInventori,
        idField: 'kode',
        textField: 'kode',
        mode: 'remote',
        sortName: 'kode',
