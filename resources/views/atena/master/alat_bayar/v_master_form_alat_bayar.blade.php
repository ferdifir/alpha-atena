                        ...
                        <form id="form_input" enctype="multipart/form-data">
                            ...
                            <table style="padding:5px" id="label_form">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input name="namaalatbayar" style="width:350px" class="label_input"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input id="MINIMALGRANDTOTAL" name="minimalgrandtotal"
                                            style="width:350px" class="number" required="true"></td>
                                </tr>
                                <tr>
                                    <td align="right" id="label_form">Urutan</td>
                                    <td colspan="2"><input id="URUTAN" name="urutan" style="width:350px"
                                            class="easyui-numberspinner" required="true" min='0'></td>
                                </tr>
                                <tr>
