  ...
  <div class="preloader">
    <div class="loader">
      ...
      <p class="loader__label">
        <img style="width: 50px;margin: 0 auto;display: block" src="{{ asset('assets/images/logo_atena.png') }}">
      </p>
    </div>
  </div>
      ...
      <div class="login-box card">
        <div class="card-body p-5">
          <form class="form-horizontal form-material" id="loginform">
            ...
            <img style="width: 200px;margin: 0 auto;display: block" src="{{ asset('assets/images/logo_atena.png') }}">
            ...
            <div class="form-group">
              <div class="col-xs-12">
                <input class="form-control" type="password" id="password" required placeholder="Kata Sandi">
              </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input class="form-control mb-3" name="konfirmasi_password_signup" id="konfirmasi_password_signup"
            type="password">
    ...
    async function login() {
      ...
      try {
        ...
        if (dataPerusahaan.length > 0) {
          ...
          //     valueSession: dataPerusahaan[0].uuidperusahaan,
          // })
          // dataSession.push({
          ...
          try {
            await $.ajax({
              ...
              data: {
                ...
                uuid_perusahaan: dataPerusahaan[0].uuidperusahaan,
              },
              success: function(response) {
            ...
            try {
              ...
              const promises = urls.map(url =>
                fetch(url, {
                  ...
                  body: JSON.stringify({
                    "uuidperusahaan": dataPerusahaan[0].uuidperusahaan,
                  }),
                  // data: {
                  //     "uuidperusahaan": dataPerusahaan[0].uuidperusahaan,
                  // }
