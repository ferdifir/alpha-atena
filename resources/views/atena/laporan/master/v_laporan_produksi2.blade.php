...
@section('content')
  <div class="easyui-layout" style="width:350px;height:100%; font-weight:bold;" fit="true">
    <div class="panel-filter-laporan" data-options="region:'west',hideCollapsedContent:false" title="{{ $menu }}">
      ...
      <input type="hidden" name="file_name" id="file_name" value="LaporanProduksi">
...
@push('js')
  <script>
    ...
    var kolomVal = "mproduksi2.kodemproduksi2"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Produksi' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
    ...
    function browse_data_produksi(id) {
      $(id).combogrid({
        panelWidth: 430,
        url: base_url + 'atena/Master/Data/Produksi2/comboGrid',
        idField: 'kode',
        textField: 'kode',
        mode: 'remote',
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            ...
            $('#txt_nilai_list_produksi').combogrid('setValue', data.nama);
          }
        }
      });
    }
