...
@section('content')
  <div class="easyui-layout" style="width:350px;height:100%; font-weight:bold;" fit="true">
    <div class="panel-filter-laporan" data-options="region:'west',hideCollapsedContent:false" title="{{ $menu }}">
      <table style="border-bottom:1px #000" id="label_laporan">
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_sopir">
              <input id="txt_nilai_list_sopir" name="txt_nilai_list_sopir" style="width:229px" prompt="Nilai" />
            </div>
          </td>
        </tr>
        <tr valign="top">
      ...
      <input type="hidden" name="file_name" id="file_name" value="LaporanSopir">
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Sopir";
    var namaKolom = "Sopir";
    var kolomVal = "msopir.kodesopir"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Sopir' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanSopir, {
        filename: "Laporan Master Sopir",
