									...
									<fieldset style="height:150px">
										...
										<table border="0" style="padding:2px">
											<tr>
												...
												<td>
													<select name="jeniskas" id="JENISKAS" style="width:190px" class="easyui-combobox" panelHeight="auto" >
													<?php
									...
									<fieldset style="height:150px">
										...
										<table border="0" style="padding:2px">
											...
											<tr>
												...
												<td><textarea name="keterangan" class="label_input" id="KETERANGAN" multiline="true" required="true" style="width:365px; height:50px" validType='length[0,300]'></textarea></td>
											</tr>
										</table>
									</fieldset>
								</td>
									...
									<fieldset style="height:150px">
										...
										<table border="0" style="padding:2px">
											<tr>
												...
												<td><input id="NOGIRO" name="nogiro" class="label_input" style="width:150px" prompt="No Giro"></td>
											</tr>
											<tr>
							...
							<tr>
								...
								<td>
									<div align="right" id="label_form" style="margin-right:25px;">
										Total Debet <input id="TOTALDEBET" name="totaldebet" class="number" style=" width:120px" readonly />
										Total Kredit <input id="TOTALKREDIT" name="totalkredit" class="number" style=" width:120px" readonly />
									</div>
								</td>
							</tr>
...
function browse_data_kas_bank(id,jeniskas) {
	...
	$(id).combogrid({
		...
		columns   : [[
			{field:'kode',title:'Kode',width:110, sortable:true},
			{field:'nama',title:'Nama',width:250, sortable:true}
		]],
		onSelect:function(index, row){
...
function browse_data_giro(id) {
	$(id).combogrid({
		...
		data      : [],
		columns   : [[
			{field:'amount',title:'Nominal',width:90, align:'right', formatter:format_amount,},
			{field:'namabank',title:'Nama Bank',width:150},
			{field:'nogiro',title:'No. Giro',width:110,},
			{field:'tglcair',title:'Tgl. Cair',width:80, formatter:ubah_tgl_indo, align:'center',},
			{field:'tglterima',title:'Tgl. Terima',width:80, formatter:ubah_tgl_indo, align:'center',},
			{field:'jenistransaksi',title:'Jenis',width:80},
			{field:'referensi',title:'Referensi',width:150},
