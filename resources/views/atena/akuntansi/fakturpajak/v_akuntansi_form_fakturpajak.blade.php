                ...
                <tr>
                    ...
                    <fieldset style="height:100px;">
                      ...
                      <table border="0">
                        <tr>
                          ...
                          <td id="label_form"><input name="nospt" id="NOSPT" class="label_input"
                              style="width:250px"></td>
                          <input type="hidden" id="UUIDFAKTURPAJAK" name="uuidfakturpajak">
                        </tr>
                        <tr>
                          <td id="label_form">Tgl. Trans</td>
                          <td id="label_form"><input name="tgltrans" id="TGLTRANS" class="date" style="width:250px">
                          </td>
                        </tr>
                      </table>
                    </fieldset>
                    ...
                    <fieldset style="height:100px;">
                      ...
                      <table border="0">
                        <tr>
                          ...
                          <td id="label_form"><input name="pembetulanke" id="PEMBETULANKE" class="easyui-numberspinner"
                              style="width:80px" prompt=""></td>
                        </tr>
                        <tr>
                          <td id="label_form">Tahun</td>
                          <td id="label_form">
                            <input name="txttahun" id="TXTTAHUN" class="easyui-numberspinner" style="width:80px"
                              prompt="Tahun" required>
                            &nbsp;&nbsp; Bulan &nbsp;&nbsp;<select name="bulanawal" id="BULANAWAL" class="easyui-combobox"
                 ...
                 <select name="bulanakhir" id="BULANAKHIR" class="easyui-combobox" style="width:95px;" required>
                  ...
                  <option value="12">DESEMBER</option>
                        ...
                        <tr>
                          <td>
                            <a class="easyui-linkbutton" iconCls="icon-save" id='btn_tampil' style="width:90px"
                              onclick="javascript:tampil()">Tampilkan</a>
                          </td>
                        </tr>
                      </table>
                    </fieldset>
                  ...
                  <td>
                    ...
                    <table border="0" style="padding-left:10px;">
                      ...
                      <!-- <tr>
               <td id="label_form"><textarea name="catatan" class="label_input" id="CATATAN" multiline="true" prompt="Catatan"
                 style="width:300px; height:95px" data-options="validType:'length[0, 500]'"></textarea></td>
              </tr> -->
                    </table>
                  </td>
                </tr>
    ...
    async function ubah() {
      ...
      if (row) {
        ...
        get_akses_user('{{ $kodemenu }}', 'bearer {{ session('TOKEN') }}', function(data) {
          ...
          var UT = data.ubah;
          console.log('ubah' + UT)
          get_status_trans('{{ session('TOKEN') }}', "atena/akuntansi/faktur-pajak", "uuidfakturpajak", row
            .uuidfakturpajak,
            function(data) {
    ...
    async function cekNoFakturPajak(no_faktur, kodejual, index) {
      ...
      for (var i = 0; i < rows.length; i++) {
        if (rows[i].nofakturpajak == no_faktur && rows[i].kodejual != kodejual) {
          $.messager.alert('Peringatan', `No. Faktur ${no_faktur} Sudah Digunakan Pada Transaksi ${rows[i].kodejual}`,
            'error');
