    ...
    <div class="panel-filter-laporan" data-options="region:'west',hideCollapsedContent:false" title="{{ $menu }}">
      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        ...
        <tr>
          ...
          <td id="label_laporan"><input id="txt_tgl_aw" name="txt_tgl_aw" style="width:106px;" class="date" /> -
            <input id="txt_tgl_ak" name="txt_tgl_ak" style="width:106px;" class="date" />
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:223px;">
              <option value="tasetbeli.kodeasetbeli">Kode Pembelian Aset</option>
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_pembelian_aset">
              <input id="txt_nilai_list_pembelian_aset" name="txt_nilai_list_pembelian_aset" style="width:223px"
                prompt="Nilai" />
            </div>
            <div id="hide_nilai_list_supplier" hidden>
              <input id="txt_nilai_list_supplier" name="txt_nilai_list_supplier" style="width:223px" prompt="Nilai" />
            </div>
...
@push('js')
  <script>
    ...
    var kolom = "Kode Pembelian Aset";
    var namaKolom = "Pembelian Aset";
    var kolomVal = "tasetbeli.kodeasetbeli"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $(document).ready(function() {
      ...
      browse_data_pembelian_aset('#txt_nilai_list_pembelian_aset');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        $('#txt_nilai_list_penyimpanan_aset').combogrid('clear');
    ...
    $("#operatorNumber").combobox({
      onChange: function() {
        ...
        if (operatorNumberVal == "NOL" || operatorNumberVal == "TIDAK NOL") {
          ...
          $('#hide_nilai_list_order_retur_beli').hide();
    ...
    $("#btn_add").click(function() {
      ...
      //UNTUK KOLOM BESERTA COMBOGRID
      if (namaKolom == 'Pembelian Aset' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_pembelian_aset').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
      } else if (namaKolom == 'Aset' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanPembelianAset, {
        kode: "{{ $kodemenu }}",
        ...
        excel: excel,
        filename: "Laporan Pembelian Aset",
      });
    }
    ...
    function browse_data_pembelian_aset(id) {
      $(id).combogrid({
        panelWidth: 230,
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_pembelian_aset').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_pembelian_aset').combogrid('setValue', data.nama);
          }
        }
      });
    }
