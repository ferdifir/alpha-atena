        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_lokasi">
              <input id="txt_nilai_list_lokasi" name="txt_nilai_list_lokasi" style="width:229px" prompt="Nilai" />
            </div>
          </td>
        </tr>
        <tr valign="top">
...
@push('js')
  <script>
    ...
    $(document).ready(function() {
      ...
      browse_data_lokasi('#txt_nilai_list_lokasi');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        $('#txt_nilai_list_lokasi').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Lokasi' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_lokasi').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function browse_data_lokasi(id) {
      $(id).combogrid({
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_lokasi').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_lokasi').combogrid('setValue', data.nama);
          }
        }
      });
    }
