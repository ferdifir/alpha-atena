      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        ...
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:227px;">
              <option value="tasetjual.kodeasetjual">Kode Penjualan Aset</option>
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_aset_jual">
              <input id="txt_nilai_list_aset_jual" name="txt_nilai_list_aset_jual" style="width:227px" prompt="Nilai" />
            </div>
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Penjualan Aset";
    var namaKolom = "Penjualan Aset";
    var kolomVal = "tasetjual.kodeasetjual"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $(document).ready(function() {
      ...
      browse_data_aset_jual('#txt_nilai_list_aset_jual');
      ...
      onChange: function() {
        ...
        if (checkData == "Kode" || checkData == "Nama") {
          ...
          if (namaKolom == 'Aset') {
            ...
            $('#hide_nilai_list_aset_jual').hide();
          } else if (namaKolom == 'Customer') {
            $('#hide_nilai_list_customer').show();
            $('#hide_nilai_list_aset').hide();
            $('#hide_nilai_list_aset_jual').hide();
          } else if (namaKolom == 'Penjualan Aset') {
            $('#hide_nilai_list_aset_jual').show();
            $('#hide_nilai_list_aset').hide();
            $('#hide_nilai_list_customer').hide();
        ...
        $('#txt_nilai_list_aset_jual').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      } else if (namaKolom == 'Penjualan Aset' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_aset_jual').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanPenjualanAset, {
        kode: "{{ $kodemenu }}",
        ...
        excel: excel,
        filename: "Laporan Penjualan Aset",
      });
    }
    ...
    function browse_data_aset_jual(id) {
      $(id).combogrid({
        panelWidth: 230,
        url: link_api.browseAsetPenjualan,
        idField: 'kode',
        textField: 'kode',
        mode: 'remote',
        sortName: 'kode',
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_aset_jual').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_aset_jual').combogrid('setValue', data.nama);
          }
        }
