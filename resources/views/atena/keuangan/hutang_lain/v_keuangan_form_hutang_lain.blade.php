                    ...
                    <div data-options="region:'north',border:false" style="width:100%; height: 400px;">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="uuidsupplier" class="label_input" id="UUIDSUPPLIER" style="width: 180px">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <br>
                                    <input type="checkbox" name="adadownpayment" id="ADADOWNPAYMENT" value="1"> Ada Down Payment -->
                                </td>
                            </tr>
                            <tr hidden>
                            ...
                            <tr>
                                <td id="label_form">Jumlah Hutang</td>
...
async function ubah() {
	...
	const response = await fetchData(
		'{{ session('TOKEN') }}',
		link_api.loadDataHeaderHutangLain, {
		kodetrans: '{{ $data }}'
		}
	);
	if(response.success) {
...
async function simpan() {
	...
	if (cekbtnsimpan && isValid && (mode == 'tambah' || mode == 'ubah')) {
		...
		try {
			...
			let url = link_api.simpanHutangLain;
