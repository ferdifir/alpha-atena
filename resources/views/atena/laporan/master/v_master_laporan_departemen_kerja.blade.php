      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        ...
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:229px;">
              <option value="mdepartemenkerja.kodedepartemenkerja">Kode Departemen Kerja</option>
              <option value="mdepartemenkerja.namadepartemenkerja">Nama Departemen Kerja</option>
            </select>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_departemen_kerja">
              <input id="txt_nilai_list_departemen_kerja" name="txt_nilai_list_departemen_kerja" style="width:229px"
                prompt="Nilai" />
            </div>
          </td>
        </tr>
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Departemen Kerja";
    var namaKolom = "Departemen Kerja";
    var kolomVal = "mdepartemenkerja.kodedepartemenkerja"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $(document).ready(function() {
      ...
      browse_data_departemen_kerja('#txt_nilai_list_departemen_kerja');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        if (checkData == "Kode" || checkData == "Nama") {
          ...
          if (namaKolom == 'Departemen Kerja') {
            $('#hide_nilai_list_barang_departemen_kerja').show();
          }
          ...
          $('#hide_nilai_list_barang_departemen_kerja').hide();
        ...
        $('#txt_nilai_list_departemen_kerja').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      //UNTUK KOLOM BESERTA COMBOGRID
      if (namaKolom == 'Departemen Kerja' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_departemen_kerja').combogrid('getValue');
    ...
    function cetakLaporan(excel) {
      parent.buka_laporan(link_api.laporanDepartemenKerja, {
        filename: "Laporan Master Departemen Kerja",
    ...
    function browse_data_departemen_kerja(id) {
      $(id).combogrid({
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_departemen_kerja').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_departemen_kerja').combogrid('setValue', data.nama);
          }
        }
      });
    }
