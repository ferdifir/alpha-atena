...
@push('js')
  <script>
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Merk' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
    ...
    function cetakLaporanMerk(excel) {
      parent.buka_laporan(link_api.laporanMerk, {
        filename: "Laporan Master Merk",
