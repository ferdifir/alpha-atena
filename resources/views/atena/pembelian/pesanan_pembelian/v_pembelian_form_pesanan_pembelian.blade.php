                                        ...
                                        <fieldset style="height:147px;">
                                            ...
                                            <table border="0">
                                                <tr>
                                                    ...
                                                    <td id="label_form"><input name="kodepo" id="KODEPO"
                                                ...
                                                <tr hidden>
                                                    ...
                                                    <td id="label_form"><input name="nopomanual" id="NOPOMANUAL"
                                                            class="label_input" style="width:190px"></td>
                                                </tr>
                                                <tr>
                                            ...
                                            <div title="Info Supplier">
                                                <table border="0">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input name="uuidsupplier" class="label_input" id="IDSUPPLIER"
                                                                style="width:100px">
                                                            <input type="hidden" id="KODESUPPLIER" name="kodesupplier">
                                                            <input name="namasupplier" class="label_input" id="NAMASUPPLIER"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <input name="alamat" class="label_input" id="ALAMAT"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <input name="telp" class="label_input" id="TELP"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input name="contactperson" class="label_input"
                                                                id="CONTACTPERSON" style="width:200px" readonly
                                                                prompt="Contact Person">
                                                            <input name="telpcp" class="label_input" id="TELPCP"
                                                                style="width:110px" readonly prompt="Telp CP">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div title="Info Pembayaran">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <input name="norekening" class="label_input" id="NOREKENING"
                                                                style="width:285px" readonly
                                                                prompt="No. Rekening Supplier">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td id="label_form">Syarat Bayar</td>
                                                        <td id="label_form">
                                                            <input name="uuidsyaratbayar" id="IDSYARATBAYAR"
                                                                class="label_input" style="width:182px">
                                                            <input name="tgljatuhtempo" id="TGLJATUHTEMPO" readonly
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" value="1" name="adanpwp"
                                                                id="ADANPWP">
                                                            <input name="npwp" class="label_input" id="NPWP"
                                                                style="width:262px" readonly prompt="NPWP Supplier">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                    ...
                                    <table>
                                        <tr hidden>
                                            <td id="label_form" align="right">
                                                Total <input name="total" id="TOTAL" class="number "
                                                    style="width:110px;" readonly required="true">
                                            </td>
                                        </tr>
                                        <tr hidden>
                                            <td align="right" id="label_form">Discount
                                                <input name="diskon" id="DISKON" class="number" style="width:60px;"
                                                    max=100 suffix="%">
                                                <input name="diskonrp" id="DISKONRP" class="number"
                                                    style="width:110px;">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td id="label_form" align="right" hidden>
                                                DPP <input name="txt_dpp" id="txt_DPP" class="number "
                                                    style="width:110px;" readonly>
                                            </td>
                                            <td id="label_form" align="right">
                                                Barang Tidak Kena Pajak <input name="barangtidakkenapajak"
                                                    id="BARANGTIDAKKENAPAJAK" class="number " style="width:110px;"
                                                    readonly>
                                            </td>
                                            <td id="label_form" align="right">
                                                Barang Kena Pajak <input name="barangkenapajak" id="BARANGKENAPAJAK"
                                                    class="number " style="width:110px;" readonly>
                                            </td>
                                            <td align="right">
                                                <label id="label_form">PPN
                                                    <input name="ppnrp" id="PPNRP" class="number"
                                                        style="width:110px;" readonly>
                                                </label>
                                            </td>
                                            <td align="right">
                                                <label id="label_form">
                                                    PPH 22
                                                    <input name="pph22rp" id="PPH22RP" class="number"
                                                        style="width:110px;" readonly>
                                                </label>
                                            </td>
                                            <td id="label_form" align="right">
                                                Pembulatan <input name="pembulatan" id="PEMBULATAN" class="number "
                                                    style="width:110px;">
                                            </td>
                                            <td id="label_form" align="right">
                                                Grand Total <input name="grandtotal" id="GRANDTOTAL" class="number "
                                                    style="width:110px;" readonly>
                                            </td>
                                        </tr>
                                    </table>
