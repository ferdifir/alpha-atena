  ...
  <div class="easyui-layout" style="width:350px;height:100%; font-weight:bold;" fit="true">
    <div class="panel-filter-laporan" data-options="region:'west',hideCollapsedContent:false" title="{{ $menu }}">
      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        <!-- FILTER LAPORAN -->
        <tr>
          <td id="label_laporan">Asal </td>
          <td><input type="text" id="txt_lokasi" name="txt_lokasi[]" style="width:220px" /></td>
        </tr>
        <tr>
      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:220px;">
              <option value="tterimatransfer.kodeterimatransfer">Kode Terima Transfer Persediaan</option>
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_terima_transfer">
              <input id="txt_nilai_list_terima_transfer" name="txt_nilai_list_terima_transfer" style="width:220px"
                prompt="Nilai" />
            </div>
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Terima Transfer Persediaan";
    var namaKolom = "Terima Transfer Persediaan";
    var kolomVal = "tterimatransfer.kodeterimatransfer";
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $(document).ready(function() {
      ...
      browse_data_lokasi('#txt_lokasi_tujuan');
      browse_data_barang('#txt_nilai_list_barang');
      browse_data_terima_transfer('#txt_nilai_list_terima_transfer');
      ...
      onChange: function() {
        ...
        if (checkData == "Kode" || checkData == "Nama") {
          ...
          if (namaKolom == 'Barang') {
            ...
            $('#hide_nilai_list_terima_transfer').hide();
          } else if (namaKolom == 'Terima Transfer Persediaan') {
            $('#hide_nilai_list_terima_transfer').show();
        ...
        $('#txt_nilai_list_terima_transfer').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      } else if (namaKolom == 'Terima Transfer Persediaan' && (operator == "Adalah" || operator ==
          "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_terima_transfer').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function browse_data_terima_transfer(id) {
      $(id).combogrid({
        panelWidth: 230,
        url: link_api.browseTerimaTransferPersediaan,
        idField: 'kode',
        textField: 'kode',
        mode: 'remote',
        sortName: 'kode',
    ...
    function cetakLaporan(excel) {
      ...
      var lokasiTujuan = getLokasiTujuan.datagrid('getSelected');

      if (lokasi != null) {
        let lokasi_tujuan = lokasiTujuan != null ? $('#txt_lokasi_tujuan').combogrid('getValues') : [];
        parent.buka_laporan(link_api.laporanTerimaTransfer, {
          kode: "{{ $kodemenu }}",
          lokasi: JSON.stringify($('#txt_lokasi').combogrid('getValues')),
          lokasi_tujuan: JSON.stringify(lokasi_tujuan),
          ...
          excel: excel,
          filename: "Laporan Terima Transfer",
        });
      } else {
