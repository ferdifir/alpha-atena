        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_saldo_stok">
              <input id="txt_nilai_list_saldo_stok" name="txt_nilai_list_saldo_stok" style="width:220px" prompt="Nilai" />
            </div>
...
@push('js')
  <script>
    ...
    $(document).ready(function() {
      ...
      browse_data_saldo_stok('#txt_nilai_list_saldo_stok');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        $('#txt_nilai_list_saldo_stok').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      if (namaKolom == 'Barang' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        ...
        nilai = $('#txt_nilai_list_saldo_stok').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
    ...
    function browse_data_saldo_stok(id) {
      $(id).combogrid({
        panelWidth: 230,
        url: link_api.browseSaldoAwalStok,
        idField: 'kode',
        textField: 'kode',
        mode: 'remote',
        sortName: 'kode',
        ...
        onSelect: function(index, data, checkdata) {
          if (checkData == "Kode") {
            $('#txt_nilai_list_saldo_stok').combogrid('setValue', data.kode);
          } else if (checkData == "Nama") {
            $('#txt_nilai_list_saldo_stok').combogrid('setValue', data.nama);
          }
        }
    ...
    function cetakLaporan(excel) {
      ...
      if (lokasi != null) {
        parent.buka_laporan(link_api.laporanSaldoAwalStok, {
          kode: "{{ $kodemenu }}",
