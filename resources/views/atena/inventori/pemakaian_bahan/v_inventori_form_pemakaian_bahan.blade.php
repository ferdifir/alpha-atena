                    ...
                    <fieldset style="height:180px;">
                      ...
                      <table border="0">
                        <tr>
                          ...
                          <td id="label_form">
                            <input name="kodepemakaianbahan" id="KODEPEMAKAIANBAHAN" class="label_input"
                              style="width:190px">
                            <input type="hidden" id="IDPEMAKAIANBAHAN" name="uuidpemakaianbahan">
                        ...
                        <tr>
                          ...
                          <td id="label_form">
                            <input name="uuidjenispemakaian" id="IDJENISPEMAKAIAN" style="width:190px">
                          </td>
                        </tr>
                        <tr>
                          <td valign="top" id="label_form">Perkiraan Biaya/HPP</td>
                          <td id="label_form">
                            <input id="KODEPERKIRAAN" name="kodeperkiraan" class="label_input" style="width:190px"
                              readonly>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td id="label_form">
                            <input id="NAMAPERKIRAAN" name="namaperkiraan" class="label_input" style="width:190px"
                              readonly>
                          </td>
                        </tr>
                        <tr>
