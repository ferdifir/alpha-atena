...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Saldo Awal Aset";
    var namaKolom = "Saldo Awal Aset";
    var kolomVal = "saldoaset.kodesaldoaset"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        namaKolom = kolom.substr(5, kolom.length - 1); // CEK JENIS FILTER APA (ASET,SALDOAWALASET)


        if (checkData == "Kode" || checkData == "Nama") {
          //UNTUK KOLOM BESERTA COMBOGRID
          if (namaKolom == 'Saldo Awal Aset') {
            $('#hide_nilai_list_aset').hide();
            $('#hide_nilai_list_saldo_awal_aset').show();
          } else if (namaKolom == 'Aset') {
            $('#hide_nilai_list_aset').show();
            $('#hide_nilai_list_saldo_awal_aset').hide();
          }
        ...
        $('#txt_nilai_list_saldo_awal_aset').combogrid('clear');
    ...
    $("#btn_add").click(function() {
      ...
      //UNTUK KOLOM BESERTA COMBOGRID
      if (namaKolom == 'Saldo Awal Aset' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_saldo_awal_aset').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
