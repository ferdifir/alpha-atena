                  ...
                  <td valign="top">
                    <table style="padding:5px" id="label_form">
                      <tr>
                        ...
                        <td><input id="KODELOKASI" name="kodelokasi" style="width:220px" class="label_input">
                          <label id="label_form"><input type="checkbox" id="STATUS" name="status" value="1">
                            Aktif</label>
                          <label id="label_form"><input type="checkbox" id="LOKASIDEFAULT" name="lokasidefault"
                              value="1"> Default</label>
                        </td>
                      </tr>
                      <tr>
                        <td style="width:75px" align="right" id="label_form">Nama</td>
                        <td><input name="namalokasi" style="width:350px" class="label_input" required="true"
                      ...
                      <tr>
                        ...
                        <td><input name="kota" style="width:350px" class="label_input" validType='length[0,100]'></td>
                      </tr>
                      <tr>
                        <td style="width:75px" align="right" id="label_form">Propinsi</td>
                        <td><input name="propinsi" style="width:350px" class="label_input" validType='length[0,100]'></td>
                      </tr>
                      <tr>
                        <td style="width:75px" align="right" id="label_form">Negara</td>
                        <td><input name="negara" style="width:350px" class="label_input" validType='length[0,100]'></td>
                      </tr>
                      <tr>
                        <td style="width:75px" align="right" id="label_form">Telp</td>
                        <td><input name="telp" style="width:350px" class="label_input" validType='length[0,100]'></td>
                      </tr>
                      <tr>
                        <td style="width:130px" align="right" id="label_form">NITKU</td>
                        <td><input name="nitku" style="width:350px" class="label_input" validType='length[0,100]'></td>
                      </tr>
                      <tr>
                        <td style="width:130px" align="right" id="label_form">Selisih Setoran
                          Minimun</td>
                        <td><input name="selisihsetoranmin" id="SELISIHSETORANMIN" style="width:350px" class="number">
                        </td>
                      </tr>
                      <tr>
                        <td style="width:130px" align="right" id="label_form">Selisih Setoran
                          Maksimum</td>
                        <td><input name="selisihsetoranmax" id="SELISIHSETORANMAX" style="width:350px" class="number">
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="width:130px" align="right" id="label_form">Akun Kas Penerima
                          Setoran Kasir</td>
                        <td><input name="idperkiraansetorankasir" id="IDPERKIRAANSETORANKASIR" style="width:350px">
                        </td>
                      </tr>
                      <tr>
                        <td style="width:130px" align="right" id="label_form">Keterangan Footer
                          Pada Nota POS</td>
                        <td>
                          <div class="easyui-texteditor" name="keteranganfooternotapos" id="KETERANGANFOOTERNOTAPOS"
                            style="height:140px;width:350px" data-options="validType:'length[0, 500]'"></div>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <table style="padding:5px" id="label_form">
                        <tr>
                          <td style="width:75px" align="right" id="label_form">Minimal
                            Transaksi</td>
                          <td>
                            <input name="minimaltransaksipoin" style="width: 100px" class="number"
