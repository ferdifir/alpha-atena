      ...
      <table style="border-bottom:1px #000" id="label_laporan">
        <tr>
          ...
          <td>
            <select id="kolom" class="easyui-combobox" name="kolom" style="width:220px;">
              <option value="saldoperkiraan.kodesaldoperkiraan">Kode Saldo Perkiraan</option>
        ...
        <tr>
          ...
          <td>
            ...
            <div id="hide_nilai_list_saldo_perkiraan">
              <input id="txt_nilai_list_saldo_perkiraan" name="txt_nilai_list_saldo_perkiraan" style="width:220px"
                prompt="Nilai" />
            </div>
            <div id="hide_nilai_list_akun" hidden>
              <input id="txt_nilai_list_akun" name="txt_nilai_list_akun" style="width:220px" prompt="Nilai" />
            </div>
          </td>
        </tr>
        <tr valign="top">
...
@push('js')
  <script>
    var counter = 0;
    var kolom = "Kode Saldo Perkiraan";
    var namaKolom = "Saldo Perkiraan";
    var kolomVal = "saldoperkiraan.kodesaldoperkiraan"
    var checkData = "Kode";
    var operator = "Adalah";
    ...
    $(document).ready(function() {
      ...
      browse_data_saldo_perkiraan('#txt_nilai_list_saldo_perkiraan');
    ...
    $("#kolom").combobox({
      onChange: function() {
        ...
        if (checkData == "Kode" || checkData == "Nama") {
          ...
          if (namaKolom == 'Saldo Perkiraan') {
            $('#hide_nilai_list_saldo_perkiraan').show();
            $('#hide_nilai_list_akun').hide();

          } else if (namaKolom == 'Akun') {
            $('#hide_nilai_list_saldo_perkiraan').hide();
    ...
    $("#btn_add").click(function() {
      ...
      //UNTUK KOLOM BESERTA COMBOGRID
      if (namaKolom == 'Saldo Perkiraan' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
        nilai = $('#txt_nilai_list_saldo_perkiraan').combogrid('getValue');
        if (nilai != "") {
          checknilai = 1;
        }
      } else if (namaKolom == 'Akun' && (operator == "Adalah" || operator == "Tidak Mencakup")) {
