          ...
          <div class="easyui-layout" style="height:100%" id="trans_layout">
                        ...
                        <td valign="top">
                          <table>
                            <tr>
                              ...
                              <td id="label_form">
                                <input id="KODESALDOPERKIRAAN" name="kodesaldoperkiraan" class="label_input"
                                  style="width:150px" prompt="Auto Generate" readonly>
                              </td>
                            </tr>
                            <tr>
                              <td id="label_form">Tgl. Trans
                              <td id="label_form"><input id="TGLTRANS" name="tgltrans" class="date"
            ...
            <div data-options="region:'south',border:false" style="width:100%; height:30px;">
              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left" id="label_form"><label style="font-weight:normal" id="label_form">User Entry
                      :</label> <label id="lbl_kasir"></label> <label style="font-weight:normal" id="label_form">| Entry
                      Date :</label> <label id="lbl_tanggal"></label>
                  </td>
                </tr>
              </table>
            </div>
  ...
  <div id="window_button_simpan" class="easyui-window" title="Konfirmasi" data-options="modal:true,closed:true"
    ...
    <center>
      <div id="button_simpan">
        ...
        <a title="Simpan & Cetak" class="easyui-linkbutton button_add_print" id='simpan_cetak' onclick="simpan(this.id)"
